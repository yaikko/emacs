...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (overlay0   "#272729" "#ffffff")
  (surface2   "#585b70" "#ffffff")
  (surface1   "#1c1b1f" "#ffffff")
  (surface0   "#100f12" "#ffffff")
  (base       "#070708" "#ffffff")
 ...
 (
  ...
  (line-number                          (:foreground "#45475A" :background nil))
  ...
  (region                               (:background surface2 :distant-foreground base))
  ...
  (doom-modeline-buffer-modified        (:foreground overlay2 :bold t))
  ...
  (doom-modeline-bar-inactive           (:background base :foreground crust))
  ...
  (solaire-default-face                         (:background surface0))
